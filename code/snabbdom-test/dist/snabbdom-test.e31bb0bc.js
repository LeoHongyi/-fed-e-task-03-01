...
// //设置元素属性
// //注册移除属性
var patch = (0, _snabbdom.init)([_class.default, _style.default, _props.default, _eventlisteners.default]);
var vnode; //存储最近一个
...
originalData[0], originalData[1], originalData[2], originalData[3], originalData[4], originalData[5], originalData[6], originalData[7], originalData[8], originalData[9]];
...
function movieView(movies) {
  return (0, _snabbdom.h)('div.row', {
    ...
    style: {
      ...
      delayed: {
        transform: "translateY(".concat(movies.offset, "px)"),
        opacity: '1'
      },
      //移入动画
      remove: {
        opacity: '0',
        transform: "translateY(".concat(movies.offset, "px) translateX(200px)")
      } //移除动画

    },
    hook: {
      insert: function insert(vnode) {
        movies.elmHeight = vnode.elm.offsetHeight;
      }
    }
  }, [(0, _snabbdom.h)('div', movies.rank), //id
  (0, _snabbdom.h)('div', movies.title), //标题
  (0, _snabbdom.h)('div', movies.desc), //描述
  (0, _snabbdom.h)('div.btn.rm-btn', {
    on: {
      click: [remove, movies]
    }
  }, 'x') //注册移除事件，传入当前节点数据
...
function view(data) {
  //基础框架
  return (0, _snabbdom.h)("div", [(0, _snabbdom.h)("h1", "Top 10 movies"), //标题
  (0, _snabbdom.h)("div", [(0, _snabbdom.h)("button.btn.add", {
    on: {
      click: add
    }
  }, "Add"), //添加
  "Stroy by：", (0, _snabbdom.h)("span.btn-group", [//排序
  (0, _snabbdom.h)("button.btn.rank", {
    class: {
      active: sortBy === 'rank'
    },
    on: {
  ...
  }, "Rank"), (0, _snabbdom.h)("button.btn.title", {
    class: {
      active: sortBy === 'title'
    },
    on: {
  ...
  }, "Title"), (0, _snabbdom.h)("button.btn.desc", {
    class: {
      active: sortBy === 'desc'
    },
    on: {
  ...
  }, data.map(movieView)) //调用 map 方法 循环数组，并处理
  ]);
}
...
//# sourceMappingURL=/snabbdom-test.e31bb0bc.js.map